...
def main():
    ...
    cell_size = int(args[args.index("--cell") + 1]) if "--cell" in args else 3
    ...
    screen_height = 800
    screen = pygame.display.set_mode((screen_height, screen_height), pygame.RESIZABLE)
    ...
    while True:
        ...
        if cell_size != 1:
            surface = pygame.transform.scale(
                surface, (cols * cell_size, rows * cell_size)
            )
